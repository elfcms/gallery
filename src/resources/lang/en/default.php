...
return [
    ...
    'gallery_creating_error' => 'Gallery creating error',
    'gallery_editing_error' => 'Gallery editing error',
    'gallery_deleting_error' => 'Gallery deleting error',
    'item_creating_error' => 'Item creating error',
    'item_editing_error' => 'Item editing error',
    'item_deleting_error' => 'Item deleting error',
    'show' => 'Show',
    'hide' => 'Hide',
    ...
    'filesize_attention' => '<b>Attention!</b> The maximum size of uploaded files is :size. To change this parameter, change the settings of the upload_max_filesize parameter in php.ini or .htaccess',
];
